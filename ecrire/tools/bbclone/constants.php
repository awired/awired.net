 ...
 *
 * $Header: /cvs/bbclone/constants.php,v 1.81 2004/10/17 01:37:33 olliver Exp $
 *
...
$vars = array(
  "BBC_ACCESS_FILE", "BBC_CACHE_PATH", "BBC_CONFIG_FILE", "BBC_CONF_PATH", "BBC_COUNTER_COLUMNS",
  "BBC_COUNTER_FILES", "BBC_COUNTER_PREFIX", "BBC_COUNTER_SUFFIX", "BBC_CUSTOM_CHARSET", "BBC_DEBUG",
  "BBC_DETAILED_STAT_FIELDS", "BBC_DOC_PATH", "BBC_IGNORE_AGENT", "BBC_IGNORE_BOTS", "BBC_IGNORE_IP",
  "BBC_IGNORE_REFER", "BBC_IMAGES_PATH", "BBC_IP2EXT_PATH", "BBC_KILL_STATS", "BBC_LANGUAGE", "BBC_LANGUAGE_PATH",
  "BBC_LAST_FILE", "BBC_LIB_PATH", "BBC_LOCK", "BBC_LOG_PROCESSOR", "BBC_MAINSITE", "BBC_MAXBROWSER",
  "BBC_MAXEXTENSION", "BBC_MAXHOST", "BBC_MAXKEY", "BBC_MAXORIGIN", "BBC_MAXOS", "BBC_MAXPAGE", "BBC_MAXROBOT",
  "BBC_MAXTIME", "BBC_MAXVISIBLE", "BBC_NO_DNS", "BBC_NO_HITS", "BBC_NUM_SIZE", "BBC_PURGE_SINGLE",
  //"BBC_ROOT_PATH",
  "BBC_SEP", "BBC_SHOW_CONFIG", "BBC_SUBTITLE_SIZE", "BBC_TEXT_SIZE", "BBC_TIMESTAMP", "BBC_TIME_OFFSET",
  "BBC_TITLEBAR", "BBC_TITLE_SIZE", "BBC_VERSION", "BBC_USE_LOCK", "access", "af", "al", "last"
);
...
function bbc_msg($item, $state = "r") {
  ...
  switch ($state) {
    ...
    case "k":
      $msg = $begin."It seems that BBClone has been successfully reset. If you keep getting this message without an "
            ."actual update however, it means the file system is denying access and returning a flag PHP doesn't "
            ."understand. On Windows NT/2k/XP/2k3 the problem will occur if the var directory only has read "
            ."permissions.";
      break;
    ...
    case "l":
      ...
      if (function_exists("sem_get")) $msg .= "use &#36;BBC_USE_LOCK = &quot;sem&quot;; in config.php however";
      elseif (function_exists("dio_fcntl")) $msg .= "use &#36;BBC_USE_LOCK = &quot;dio&quot;; in config.php however";
    ...
    case "o":
      $msg = $begin."It seems that BBClone has successfully written to file ".$item.". If you keep getting this "
            ."message without an actual update however, it means the file system is denying access and returning a "
            ."flag PHP doesn't understand. On Windows NT/2k/XP/2k3 the problem will occur if the var directory only "
