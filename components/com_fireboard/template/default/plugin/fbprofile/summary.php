<?php
/**
* @version $Id: myprofile_summary.php 137 2007-05-27 05:22:50Z greatpixels $
* Fireboard Component
* @package Fireboard
...
<table class = "fb_blocktable" id = "fb_forumprofile_sub" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
  ...
  <tbody  class = "fb_myprofile_general" id = "<?php echo $boardclass ;?>fbusersummary_tbody">
    ...
    <tr class ="<?php echo $boardclass; ?>sectiontableentry1">
      ...
      <td  class = "td-2 fbm"><?php if( $userinfo->gender == 1 ) { echo 'male'; } else if ( $userinfo->gender == 2 ) { echo 'female'; } else { }  ?></td>
    </tr>
    <?php } ?>
