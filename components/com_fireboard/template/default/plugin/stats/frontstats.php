<?php
/**
* @version $Id: frontstats.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
...
$forumurl = sefReltoAbs('index.php?option=com_fireboard');
...
<?php echo _STAT_TOTAL_USERS; ?>:<b> <a href = "<?php echo $userlist;?>"><?php echo $totalmembers; ?></a> </b>
    ...
    _STAT_YESTERDAY_OPEN_THREAD; ?>: <b> <?php echo $yesterdaystitle; ?></b> &nbsp; <?php echo _STAT_TODAY_TOTAL_ANSWER; ?>: <b> <?php echo $todaytotal; ?></b> &nbsp; <?php echo _STAT_YESTERDAY_TOTAL_ANSWER; ?>: <b> <?php echo $yesterdaytotal; ?></b>
                ...
                &raquo; <a href = "<?php echo sefRelToAbs('index.php?option=com_fireboard&amp;func=latest');?>"><?php echo _STAT_VIEW_RECENT_POSTS_ON_FORUM; ?></a> &raquo; <a href = "<?php echo $statslink;?>"><?php echo _STAT_MORE_ABOUT_STATS; ?></a> &raquo; <a href="<?php echo $userlist;?>"><?php echo _STAT_USERLIST; ?></a> 
                    </td>
                </tr>
            </tbody>
        </table>
