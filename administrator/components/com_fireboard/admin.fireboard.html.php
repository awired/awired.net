<?php
/**
* @version $Id: admin.fireboard.html.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
  ...
  <tr>
    ...
    <!-- Begin: AdminLeft -->
        ...
        <a class="fbmainmenu" href = "index2.php?option=com_fireboard"><?php echo _FB_CP; ?></a>
           ...
           <a class="fbmainmenu"  href = "index2.php?option=com_fireboard&task=pruneusers"><?php echo _COM_C_PRUNEUSERS; ?></a>    
...
<?php } // Finish: FOOTER FUNC
    ...
    {
        global $mainframe, $mosConfig_admin_template;
?>
		...
		<div class="fbfuncsubtitle"><?php echo _COM_A_FRONTEND ?> <a name="frontend" id="frontend" > </a></div>
                                                            ...
                                                            <td>
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <td>
                                                                            6:
                                                                        <img src = "<?php echo $mosConfig_live_site;?>/components/com_fireboard/template/<?php echo $fbConfig['template'] ;?>/images/english/graph/col6m.png" width = "15" height = "4">
                                                            ...
                                                            <td>
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <img src = "<?php echo $mosConfig_live_site;?>/components/com_fireboard/template/<?php echo $fbConfig['template'] ;?>/images/english/graph/col12m.png" width = "15" height = "4">
          ...
          <fieldset>
            ...
            <table cellpadding = "4" cellspacing = "0" border = "0" width = "100%" class = "fbadminform">
				...
				<tr align = "center" valign = "middle">
                    <td align = "left" valign = "top"><?php echo 'Image Processor:' ?>
                    </td>
                ...
                <tr align = "center" valign = "middle">
                    <td align = "left" valign = "top"><?php echo _FB_AVATAR_MEDUIM_WIDTH ?>
                    </td>
...
<?php
    ...
    function showInstructions($database, $option, $mosConfig_lang) {
        include ("components/com_fireboard/fireboard_config.php");
?>
...
if ($avatar != '')
{
   echo '<img src="../components/com_fireboard/avatars/' . $avatar . '" ><br />';
...
<?php
    ...
    function pruneusers($option) {
        include ('components/com_fireboard/fireboard_config.php');
?>
<div class="fbfunctitle"><?php echo _COM_A_PRUNE_USERS; ?></div>
    <form action = "index2.php" method = "post" name = "adminForm">
        ...
        <table cellpadding = "4" class = "adminform" cellspacing = "0" border = "0" width = "100%">
            ...
            <tr>
                <td colspan = "2"><?php echo _COM_A_PRUNE_USERS_DESC ?>
                </td>
            </tr>
        </table>
 ...
 function showRanks( $option,$mosConfig_lang,&$ranks,$pageNavSP,$order,$rankpath )  
   ...
   <table class="adminlist" border=0 cellspacing=0 cellpadding=3 width="100%" >
    ...
    <?php 
     ...
     <td><?php if ($row->rank_special == 1 ) { echo 'Yes'; } else { echo 'No'; } ?></td>
