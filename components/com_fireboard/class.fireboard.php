<?php
/**
* @version $Id: class.fireboard.php 317 2007-09-05 13:20:40Z danialt $
* Fireboard Component
* @package Fireboard
...
function fbGetArrayInts($name, $type = NULL) {
    ...
    $chunks = array(
    array(60 * 60 * 24 * 365 , _FB_DATE_YEAR),
    array(60 * 60 * 24 * 30 , _FB_DATE_MONTH),
    array(60 * 60 * 24 * 7, _FB_DATE_WEEK),
    array(60 * 60 * 24 , _FB_DATE_DAY),
    array(60 * 60 , _FB_DATE_HOUR),
    array(60 , _FB_DATE_MINUTE),
    );
