<?php
/**
* @version $Id: fb_write.html.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
...
<table class = "fb_blocktable<?php echo $objCatInfo->class_sfx; ?>" id="fb_postmessage"  border = "0" cellspacing = "0" cellpadding = "0" width="100%">
    ...
    <tbody id = "fb_post_message">
        ...
        <tr class = "<?php echo $boardclass; ?>sectiontableentry1">
			...
			<img src="<?php echo JB_DIRECTURL ;?>/template/default/plugin/captcha/randomImage.php">
		 </td>
         </tr>    
        <?php
		}
        ...
        <tr>
            <td colspan = "2" style = "text-align: center;">
                ...
                <input type = "button"
                    class = "button"
                    value = "<?php echo _PREVIEW;?>" onclick = "Preview('<?php echo JB_JCSSURL;?>', '<?php echo JB_DIRECTURL;?>', '<?php echo $fbConfig['template'];?>', '<?php echo $fbConfig['disemoticons'];?>')" onmouseover = "helpline('preview')"/>
