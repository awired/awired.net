...
DEFINE('_COM_SEF_CONFIGDESC','Konfigurieren Sie alle 404SEFx Einstellungen');
DEFINE('_COM_SEF_HELP','404SEFx<br/>Hilfe');
DEFINE('_COM_SEF_HELPDESC','Brauchen Sie Hilfe mit 404SEFx?');
DEFINE('_COM_SEF_INFO','404SEFx<br/>Dokumentation');
DEFINE('_COM_SEF_INFODESC','Betrachten Sie die 404SEF Projekt Zusammenfassung und Dokumentation');
