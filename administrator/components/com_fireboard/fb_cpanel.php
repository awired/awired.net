<?php
/**
* @version $Id: fb_cpanel.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
  ...
  <table class = "thisform">
    <tr class = "thisform">
      <td width = "100%" valign = "top" class = "thisform"><div id = "cpanel">
          ...
          <div style = "float:left;">
            <div class = "icon"> <a href = "index2.php?option=com_fireboard&amp;task=pruneusers" style = "text-decoration:none;" title = "<?php echo _COM_C_PRUNEUSERSDESC;?>"> <img src = "components/com_fireboard/images/fbusers.png"  align = "middle" border = "0"/> <span> <?php echo _COM_C_PRUNEUSERS; ?> </a> </div>
          </div>
          <div style = "float:left;">
