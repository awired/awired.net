...
DEFINE("_AKOCOMMENT_CREATELINK","Um einen Link zu diesem Artikel zu setzen,<br />kopieren Sie bitte den folgenden Code in den HTML-Code Ihrer Seite oder Ihres Artikels.");
...
DEFINE("_AKOCOMMENT_SAVED4UNPUBLISHED","Ihr Kommentar wurde gespeichert und einem Administrator zugestellt. Bei Regelverst&ouml;ssen erfolgt keine Ver&ouml;ffentlichung.");
DEFINE("_AKOCOMMENT_GOHOME","Zur Homepage");
DEFINE("_AKOCOMMENT_YOURFAVOURED","Ihre Favoriten");
DEFINE("_AKOCOMMENT_YOURFAVOUREDUSER","Ihre favorisierten Artikel");
DEFINE("_AKOCOMMENT_FAVOUREDUSERMUSTLOGIN","Nur registrierte Benutzer k&ouml;nnen Favoriten hinzuf&uuml;gen.<br />Bitte melden Sie sich an oder registrieren Sie sich.");
...
DEFINE("_AKOCOMMENT_YOUHAVEFAVOUREDTHISARTICLE","Sie haben diesen Artikel bereits zu Ihren Favoriten hinzugef&uuml;gt.");
DEFINE("_AKOCOMMENT_THANKFAVOURED","Danke f&uuml;r Ihre Favorisierung.");
DEFINE("_AKOCOMMENT_FAVOUREDREMOVE","L&ouml;schen");
DEFINE("_AKOCOMMENT_NOFAVOURED","Keine Favoriten");
DEFINE("_AKOCOMMENT_WHATYOUWANT","Was m&ouml;chten Sie tun ?");
DEFINE("_AKOCOMMENT_FAVOUREDONLYREGISTERED","Nur registrierte Benutzer k&ouml;nnen favorisieren. <br />Bitte melden Sie sich an oder registrieren Sie sich.");
...
DEFINE("_AKOCOMMENT_REPORTINTRO","Danke, da&szlig; Sie sich die Zeit genommen haben, diesen Kommentar an den Administrator dieser Seite zu melden.");
DEFINE("_AKOCOMMENT_REPORTINTRO2","Bitte vervollst&auml;ndigen Sie dieses Formular und klicken Sie anschlie&szlig;end auf den Senden Button, um Ihre Meldung abzuschlie&szlig;en.");
DEFINE("_AKOCOMMENT_REASON_REPORT","Grund f&uuml;r Ihre Meldung");
DEFINE("_AKOCOMMENT_COMMENTINQUESTION","Fragen oder Hinweise zum Kommentar");
DEFINE("_AKOCOMMENT_THANKS4UREPORT","Danke. Ihre Meldung wurde an den Administrator dieser Seite weitergeleitet.");
...
DEFINE("_AKOCOMMENT_FORMREPORTVALIDATE","Bitte geben Sie ein Grund f&uuml;r die Meldung des Kommentars an.");

// Email language definitions for subscribe new comment
DEFINE("_AKOCOMMENT_SUBSCRIBEMAILHEADER","Neuer Kommentar");
DEFINE("_AKOCOMMENT_SUBSCRIBEMAIL","Hallo,\n\nein Benutzer hat einen neuen Kommentar zu einem Artikel hinzugef&uuml;gt. Sie finden den Artikel auf $mosConfig_live_site:\n");
DEFINE("_AKOCOMMENT_SUBSCRIBEMAILFOOTER","Bitte antworten Sie nicht auf diese Nachricht. Sie wurde automatisch generiert und dient ausschlie&szlig;lich zu Ihrer Information.\n");

DEFINE("_AKOCOMMENT_WRITEPOLICY","<ul><li>Bitte orientieren Sie Ihren Kommentar am Thema des Beitrages.</li><li>Pers&ouml;nliche Angriffe und/oder Diffamierungen werden gel&ouml;scht.</li><li>Das Benutzen der Kommentarfunktion f&uuml;r Werbezwecke ist nicht gestattet. Entsprechende Kommentare werden gel&ouml;scht.</li><li>Bei Fehleingaben laden Sie diese Seite bitte neu damit ein neuer Sicherheitscode generiert werden kann. Erst dann klicken Sie bitte auf den 'Senden' Button.</li><li>Der vorgenannte Schritt ist nur erforderlich, wenn Sie einen falschen Sicherheitscode eingegeben haben.</li></ul>");
DEFINE("_AKOCOMMENT_COMMENTS","Kommentare");
DEFINE("_AKOCOMMENT_ONLYREGISTERED","Nur registrierte Benutzer k&ouml;nnen Kommentare schreiben.<br />Bitte melden Sie sich an oder registrieren Sie sich.");
...
DEFINE("_AKOCOMMENT_FORMVALIDATE","Bitte geben Sie einen Kommentar ein!");
DEFINE("_AKOCOMMENT_FORMVALIDATENAME","Bitte geben Sie einen Namen ein!");
...
DEFINE("_AKOCOMMENT_SAVED","Ihr Kommentar zu dem Artikel wurde gespeichert! Wenn Ihr Kommentar nicht in Zusammenhang mit dem obigen Artikel steht, wird er gel&ouml;scht.");
...
DEFINE("_AKOCOMMENT_ADMINMAILFOOTER","Bitte antworten Sie nicht auf diese Nachricht. Sie wurde automatisch generiert und dient ausschlie&szlig;lich zu Ihrer Information.\n");
