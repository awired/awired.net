                ...
                <?php
                    ...
                    if ($fbConfig['avatarOnCat'] > 0)
                    {
                        ...
                        if ($fbConfig['avatar_src'] == "cb") {
                            ...
                            $bof_avatar = '<img class="catavatar" src="components/com_fireboard/avatars/' . $javatar . '" alt=" " />';
                            }
                    // //////////
                    }
                ?>
...
<?php echo $leaf->moved ? "---" : (int)$thread_counts[$leaf->id]; ?>
                            </td>

                            <td class = "td-5 fbm" align="center">
<?php echo $leaf->moved ? "---" : (int)$hits[$leaf->id]; ?>
                            </td>
