	...
	<tr>
    		...
    		?>
    			<td>
    				...
    				<a href="<?php echo sefRelToAbs( 'index.php?option=com_registration&amp;task=register' ); ?>">
    			     ...
    			     <a href="<?php echo sefRelToAbs( 'index.php?option=com_registration&amp;task=lostPassword' ); ?>">?</a>
    			     &nbsp;&nbsp;
    			</td>
    		<?php
    	}
		...
		<td>
			<input name="username" id="mod_login_username" type="text" class="inputbox" alt="username" size="10"
	           onfocus="if(this.value=='Login') this.value='';" onblur="if(this.value=='') this.value='Login';" value="Login" />
			<input type="password" id="mod_login_password" name="passwd" class="inputbox" size="10" alt="password"
	           onfocus="if(this.value=='Pass') this.value='';" onblur="if(this.value=='') this.value='Pass';" value="Pass" />
			<input type="checkbox" name="remember" id="mod_login_remember" class="inputbox" value="yes" alt="Remember Me" style="display:none"/>
			<input type="submit" name="Submit" class="button" value="<?php echo _BUTTON_LOGIN; ?>" style="display:none"/>
