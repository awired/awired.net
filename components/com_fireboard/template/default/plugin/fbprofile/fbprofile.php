<?php
/**
* @version $Id: fbprofile.php 305 2007-08-31 11:33:57Z danialt $
* Fireboard Component
* @package Fireboard
...
{
    global $database, $fbConfig,  $mosConfig_offset, $acl, $fbIcons, $my, $mosConfig_absolute_path;
    ...
    if ($fbConfig['allowAvatar'])
    {
        ...
        if ($fbConfig['avatar_src'] == "clexuspm") {
            $msg_avatar = '<span class="fb_avatar"><img src="' . MyPMSTools::getAvatarLinkWithID($userid, "b") . '" /></span>';
        }
                ...
                $msg_avatar = '<span class="fb_avatar"><img src="' . $imgpath . '" /></span>';
        ...
        else
                                    {
                                        ...
                                        if ($avatar != '') {
                                            ...
                                            $msg_avatar = '<span class="fb_avatar"><img border="0" src="' . FB_LIVEUPLOADEDPATH . '/avatars/l_' . $avatar . '" /></span>';									
											}
                                        }
										
                                    	else {$msg_avatar = '<span class="fb_avatar"><img  border="0" src="' . FB_LIVEUPLOADEDPATH . '/avatars/nophoto.jpg" /></span>'; }
                                    }
                                }
