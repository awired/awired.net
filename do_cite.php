...
<li class="level1"><div class="li"> Author: <?php echo tpl_getConf('mb_author');?></div>
</li>
...
<p>
 <?php echo tpl_getConf('mb_author');?> (<?php echo date('Y', $_REQUEST['rev']); ?>). <?php tpl_pagetitle()?>. <?php echo hsc($conf['title'])?>. Retrieved <?php echo date('H:i, j F, Y'); ?> from <a href="<?php echo $permanent; ?>" title="<?php echo $permanent; ?>"><?php echo $permanent; ?></a>.
</p>
...
<p>
 <?php echo tpl_getConf('mb_author');?>, &lsquo;<?php tpl_pagetitle()?>&rsquo;, <?php echo hsc($conf['title'])?>, <?php echo date('j F Y, H:i T', $_REQUEST['rev']); ?>, &lt;<a href="<?php echo $permanent; ?>" title="<?php echo $permanent; ?>"><?php echo $permanent; ?></a>&gt; [accessed <?php echo date('j F Y'); ?>]
</p>
...
<p>
 <?php echo tpl_getConf('mb_author');?>, &ldquo;<?php tpl_pagetitle()?>,&rdquo; <?php echo hsc($conf['title'])?>, <a href="<?php echo $permanent; ?>" title="<?php echo $permanent; ?>"><?php echo $permanent; ?></a> (accessed <?php echo date('F j, Y'); ?>).
</p>
...
<p>
 <?php echo tpl_getConf('mb_author');?>. <?php tpl_pagetitle()?> [Internet]. <?php echo hsc($conf['title'])?>; <?php echo date('Y M j, H:i T', $_REQUEST['rev']); ?> [cited <?php echo date('Y M j'); ?>]. Available from: <a href="<?php echo $permanent; ?>" title="<?php echo $permanent; ?>"><?php echo $permanent; ?></a>.
</p>
...
<p>
 <?php echo tpl_getConf('mb_author');?>. <?php tpl_pagetitle()?>. <?php echo hsc($conf['title'])?>. <?php echo date('F j, Y, H:i T', $_REQUEST['rev']); ?>. Available at: <a href="<?php echo $permanent; ?>" title="<?php echo $permanent; ?>"><?php echo $permanent; ?></a>. Accessed <?php echo date('F j, Y'); ?>.
...
<pre>
 @misc{ wiki:xxx,
   author = &quot;<?php echo tpl_getConf('mb_author');?>&quot;,
