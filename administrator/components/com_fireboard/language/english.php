...
DEFINE('_FB_AVATAR_MEDUIM_WIDTH','Medium Image Width :');
...
DEFINE('_FB_USERSPRUNEDDELETED', 'Users pruned; Deleted:');
DEFINE('_FB_PRUNEUSERPROFILES', 'user profiles');
DEFINE('_FB_NOPROFILESFORPRUNNING', 'No profiles found eligible for pruning.');
...
DEFINE('_FB_INSTALL1', '<strong>Fireboard Forum</strong> Component <em>for Joomla! CMS</em> <br />&copy; 2006 - 2007 by Best Of Joomla<br>All rights reserved.');
...
DEFINE('_FB_THREADS_IN_FORUM', 'Thread in Forum ');
...
//  STARTS HERE!
DEFINE('_FB_WHO_LATEST_POSTS', 'Latests Posts');
...
DEFINE('_COM_C_PRUNEUSERS', 'Prune Users');
DEFINE('_COM_C_PRUNEUSERSDESC', 'Sync Fireboard user table with Joomla! user table');
